...
export const DecodePacketError$More = (length) => new More(length);
export const DecodePacketError$isMore = (value) => value instanceof More;
export const DecodePacketError$More$length = (value) => value.length;
export const DecodePacketError$More$0 = (value) => value.length;
...
export const DecodePacketError$HttpError = (reason) => new HttpError(reason);
export const DecodePacketError$isHttpError = (value) =>
  value instanceof HttpError;
export const DecodePacketError$HttpError$reason = (value) => value.reason;
export const DecodePacketError$HttpError$0 = (value) => value.reason;
