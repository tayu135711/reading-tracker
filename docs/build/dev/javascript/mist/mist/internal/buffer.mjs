...
export const Buffer$Buffer = (remaining, data) => new Buffer(remaining, data);
export const Buffer$isBuffer = (value) => value instanceof Buffer;
export const Buffer$Buffer$remaining = (value) => value.remaining;
export const Buffer$Buffer$0 = (value) => value.remaining;
export const Buffer$Buffer$data = (value) => value.data;
export const Buffer$Buffer$1 = (value) => value.data;
...
export function with_capacity(buffer, size) {
  return new Buffer(size, buffer.data);
}
