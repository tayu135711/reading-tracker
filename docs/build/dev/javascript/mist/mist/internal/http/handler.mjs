...
export const State$State = (idle_timer) => new State(idle_timer);
export const State$isState = (value) => value instanceof State;
export const State$State$idle_timer = (value) => value.idle_timer;
export const State$State$0 = (value) => value.idle_timer;
