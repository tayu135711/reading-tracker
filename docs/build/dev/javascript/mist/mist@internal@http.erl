...
?DOC(false).
-spec add_date_header(gleam@http@response:response(JUU)) -> gleam@http@response:response(JUU).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(JUX)) -> gleam@http@response:response(JUX).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(JVA)) -> gleam@http@response:response(JVA).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(JVD)) -> gleam@http@response:response(JVD).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(JVI)) -> gleam@http@response:response(JVI)).
